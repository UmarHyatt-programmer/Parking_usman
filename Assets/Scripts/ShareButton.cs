...
public class ShareButton : MonoBehaviour
{
    ...
    public IEnumerator ShareTextInAnroid()
    {
        ...
        var shareSubject = "This is Best Truck Parking Game";
        var shareMessage = "Feel Free To PLAY. " +
                           "Get the Free Truck Parking Game app from the link below. \nCheers\n\n" +
                           "https://play.google.com/store/apps/details?id=com.DefaultCompany.RCCTruck";
                           //Debug.Log("share button working");
